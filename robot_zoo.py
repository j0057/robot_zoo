...
cron = pycron.CronRunner(
    ...
    #                                                                   @msvlieland
    , ('*        15       10       04-13    feb      2012     *       ', msvlieland.sound_horn)
    , ('*        30       15       04-13    feb      2012     *       ', msvlieland.sound_horn)

    , ('*        00       09       04-13    feb      2012     *       ', msvlieland.geen_afvaart)
    , ('*        00       09       *        *        *        *       ', msvlieland.sound_horn)

    , ('*        15       14       04-13    feb      2012     *       ', msvlieland.geen_afvaart)
    , ('*        15       14       *        *        *        *       ', msvlieland.sound_horn)

    , ('*        00       19       04-13    feb      2012     *       ', msvlieland.geen_afvaart)
